...
def failure_mail(context):
    ...
    send_mail("Unable to retrieve the weather data after multiple attempts for the execution date: " + formatted_date + " 00 UTC.")

with DAG('weather_data_processing_00UTC',start_date=datetime(2025, 5, 1, 0, 0),
    schedule_interval='00 6 * * *', catchup=False) as dag:
    ...
    op_kwargs={"prefix":"weather_data/processed/"+str(inputdate)+"/"+"00_utc"},  
    )
